...
// Function to perform FFT for variable data sizes
...
int main() {
    ...
    if (choice == 'y' || choice == 'Y') {
        ...
        // Ask if they want to perform FFT on variable number of data points
        ...
        // If not performing variable size FFT, continue with fixed size FFT below
    } else {
    ...
    // Proceed with fixed size FFT as originally implemented
